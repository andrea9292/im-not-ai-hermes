...
External pre-processor for the Hermes fast path. Run before rewriting
— its output (prepended to the input text) gives the LLM a numerical
...
regex + a small hanja suffix dictionary. Final judgement belongs to the
Hermes editing workflow.
