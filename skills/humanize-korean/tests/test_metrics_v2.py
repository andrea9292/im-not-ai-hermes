"""Tests for the Hermes humanize-korean v2.0 metrics module.

Runs under pytest OR `python -m unittest`. Imports both v1.6 metrics.py
and v2.0 metrics_v2.py from the sibling references/ directory in the
Hermes skill port.
"""
